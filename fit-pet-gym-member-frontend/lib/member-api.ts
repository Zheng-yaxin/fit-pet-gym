...
export type CourseFeedbackPending = {
  enrollmentId?: number;
  scheduleId?: number;
  bookingId?: number;
  courseId?: number;
  coachId?: number;
  feedbackType?: "course" | "personal_training" | string;
  courseName?: string;
  coachName?: string;
  classTime?: string;
  startTime?: string;
...
export function getPendingCourseFeedback() {
  return apiRequest<CourseFeedbackPending[]>("/course/feedback/pending");
}

export function submitCourseFeedback(payload: {
  scheduleId?: number;
  bookingId?: number;
  courseId?: number;
  coachId?: number;
  ...
  return apiRequest<void>("/course/feedback", {
    method: "POST",
    body: JSON.stringify(payload)
  });
}
...
export function getMyCourseFeedback() {
  return apiRequest<CourseFeedback[]>("/course/feedback/mine");
}
